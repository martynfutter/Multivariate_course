...
#guard to prevent multiple install
if(!is.element("vegan",installed.packages()[,1])) {install.packages("vegan") }
...
if(!is.element("tibble",installed.packages()[,1])) {install.packages("tibble") }
if(!is.element("labdsv",installed.packages()[,1])) {install.packages("labdsv") }
if(!is.element("knitr",installed.packages()[,1])) {install.packages("knitr") }
if(!is.element("dendextend",installed.packages()[,1])) {install.packages("dendextend") }
if(!is.element("pls",installed.packages()[,1])) {install.packages("pls") }
if(!is.element("adespatial",installed.packages()[,1])) {install.packages("adespatial") }
```
